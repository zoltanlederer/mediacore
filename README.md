...
![List view with filters, pagination, and watched status](./screenshots/list-view.jpg)
...
- List view (`/`) — data table with poster thumbnails, clickable titles, genre/type filter dropdowns, pagination controls, and an inline watched-status toggle
...
- Responsive layout for mobile (stacked header, scrollable table, stacked detail view)
- Dark theme with a consistent accent color system
...
## Status
Complete: backend routes, filtering, pagination, full React frontend with routing/forms/context, styling, and responsive layout. Remaining: deployment.